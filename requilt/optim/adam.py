...
def adam_step_kernel(GDTYPE, DTYPE):
    @nested_kernel
    def adam_step(
        g: wp.array(dtype=GDTYPE),
        m: wp.array(dtype=DTYPE),
        v: wp.array(dtype=DTYPE),
        lr: float,
        beta1: float,
        beta2: float,
        t: float,
...
adam_step_kernel_float = adam_step_kernel(wp.float32, wp.float32)
# adam_step_kernel_half = adam_step_kernel(wp.float16, wp.float32)
# adam_step_kernel_vec3 = adam_step_kernel(wp.vec3, wp.vec3)
